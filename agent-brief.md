...
> Typically written right after [product-requirement-document](product-requirement-document.md) publishes the issue: the PRD records the decisions for humans; this brief is the durable spec the agent executes against.
